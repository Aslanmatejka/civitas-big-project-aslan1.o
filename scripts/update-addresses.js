...
`;
  ...
  // ── Update web-app/.env.local with VITE_ prefixed contract addresses ─────────
  ...
  const viteEnv =
    ...
    `# Re-run: npm run update-addresses\n\n` +
    ...
    Object.entries(contracts)
      ...
      .join('\n') +
    '\n';
  fs.writeFileSync(webAppEnvPath, viteEnv);
  console.log('✅ Updated web-app/.env.local with contract addresses');
  console.log('');

  console.log('🎉 Configuration complete!');
  console.log('');
  console.log('📋 Next steps:');
  console.log('   1. cd messaging-backend && node server.js');
  console.log('   2. cd web-app && npx vite --host');
